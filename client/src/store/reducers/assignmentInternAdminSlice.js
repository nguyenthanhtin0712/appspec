...
const assignment_intern = createSlice({
  name: 'assignment_intern',
  initialState,
  reducers: {
...
export const { setColumnFilters, setGlobalFilter, setSorting, setPagination } = assignment_intern.actions;

export default assignment_intern.reducer;
