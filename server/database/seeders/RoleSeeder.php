...
class RoleSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $subject_schedule_view = Permission::create(['name' => 'subject_schedule.view', 'desc' => 'Xem lịch học', 'functional_code' => 'subject_schedule']);
        $subject_schedule_create = Permission::create(['name' => 'subject_schedule.create', 'desc' => 'Tạo lịch học', 'functional_code' => 'subject_schedule']);
        $subject_schedule_delete = Permission::create(['name' => 'subject_schedule.delete', 'desc' => 'Xoá lịch học', 'functional_code' => 'subject_schedule']);
        $subject_schedule_delete = Permission::create(['name' => 'subject_schedule.update', 'desc' => 'Cập nhật lịch học', 'functional_code' => 'subject_schedule']);
